...
export interface ConfidentialPayrollTokenInterface extends Interface {
  getFunction(
    nameOrSignature:
...
export interface ConfidentialPayrollToken extends BaseContract {
  connect(runner?: ContractRunner | null): ConfidentialPayrollToken;
  waitForDeployment(): Promise<this>;

  interface: ConfidentialPayrollTokenInterface;
